...
ProfileRepositoryPostgres::ProfileRepositoryPostgres(std::shared_ptr<pqxx::connection> conn)
    : conn_(std::move(conn)) {}

domain::Profile ProfileRepositoryPostgres::Create(const std::string& user_id) {
    pqxx::work txn(*conn_);
...
domain::Profile ProfileRepositoryPostgres::GetByID(const std::string& user_id) {
    pqxx::work txn(*conn_);
...
void ProfileRepositoryPostgres::UpdateAvatarURL(const std::string& user_id, const std::string& url) {
    pqxx::work txn(*conn_);
